...
{
    internal partial class ProductOutboxEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType? baseEntityType = null)
        {
            var runtimeEntityType = model.AddEntityType(
                "Mjos.Learn.ProductCatalog.Domain.Outbox.ProductOutbox",
                typeof(ProductOutbox),
                baseEntityType);
            ...
            key.AddAnnotation("Relational:Name", "pk_product_outboxes");

            var index = runtimeEntityType.AddIndex(
                new[] { id },
                unique: true);
            index.AddAnnotation("Relational:Name", "ix_product_outboxes_id");
        ...
        public static void CreateAnnotations(RuntimeEntityType runtimeEntityType)
        {
            ...
            runtimeEntityType.AddAnnotation("Relational:TableName", "product_outboxes");
