...
namespace Mjos.Learn.ProductCatalog.Data.Migrations
{
    ...
    [Migration("20230922084006_InitialProductCatalogDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mjos.Learn.ProductCatalog.Domain.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Mjos.Learn.ProductCatalog.Domain.Outbox.ProductOutbox", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Mjos.Learn.ProductCatalog.Domain.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Mjos.Learn.ProductCatalog.Domain.SupplierInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Mjos.Learn.ProductCatalog.Views.ProductView", b =>
                {
            ...
            modelBuilder.Entity("Mjos.Learn.ProductCatalog.Domain.Product", b =>
                {
                    b.HasOne("Mjos.Learn.ProductCatalog.Domain.Category", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .HasConstraintName("fk_products_categories_category_temp_id1");

                    b.HasOne("Mjos.Learn.ProductCatalog.Domain.SupplierInfo", "SupplierInfo")
                        .WithMany()
